defmodule ChatWeb.Components.Spinner do
  @moduledoc """
  The `ChatWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `ChatWeb.Components.Spinner` module enables developers to provide
